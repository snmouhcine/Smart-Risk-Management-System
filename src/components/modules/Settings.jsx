        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Clé API Anthropic (optionnel)</label>
                <input
                  type="password"
                ...
                <div className="text-xs text-slate-500 mt-1">
                  ⚙️ Optionnel : Votre clé API pour l'analyse IA (laissez vide pour utiliser le système intégré)
                </div>
              </div>
