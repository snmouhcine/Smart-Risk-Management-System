...
import AuthGuard from './components/auth/AuthGuardSimple'
...
import BypassNotice from './components/BypassNotice'
import DirectDashboard from './components/DirectDashboard'
...
function AppContent() {
  ...
  React.useEffect(() => {
    // BYPASS MODE - Skip database check
    setIsAdmin(false)
  ...
  return (
    <>
      ...
      <Routes>
          ...
          <Route path="/direct" element={<DirectDashboard />} />
